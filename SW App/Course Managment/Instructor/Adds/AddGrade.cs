    ...
    public partial class AddGrade : Form
    {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.SID.Text) ||
                ...
                string.IsNullOrEmpty(this.Semester.Text) ||
            ...
            {
                SqlCommand command = new SqlCommand("UPDATE ENROLL_IN SET GRADE = @Grade WHERE SID = @SID AND CID = @CrsID AND SEMESTER = @Semester", connection);
